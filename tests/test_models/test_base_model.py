#!/usr/bin/python3
"""
Contains all unittests for the BaseModel class
"""
...
class TestBasemodel(unittest.TestCase):
    ...
    def setUp(self):
        """
        define some operations before the tests
        """
        pass
    ...
    def test_kwargs_int(self):
        """
        Tests the kwargs initialization
        """
        i = self.value()
        copy = i.to_dict()
        copy.update({1: 2})
    ...
    def test_str(self):
        """
        Tests the __str__ function of the BaseModel
        """
        i = self.value()
    ...
    def test_todict(self):
        """
        Tests the to_dict function of the model
        """
        i = self.value()
        d = i.to_dict()
        ...
        self.assertIn('lastname', self.value(lastname='Akpa').to_dict())
    ...
    def test_delete(self):
        """Tests the delete BaseModel class."""
